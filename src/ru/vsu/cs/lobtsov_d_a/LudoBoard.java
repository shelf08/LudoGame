...
class LudoBoard {
    ...
    LudoBoard() {
        ...
        positionMap.put("Зеленый", greenHomePos);
        positionMap.put("Желтый", yellowHomePos);
        positionMap.put("Красный", redHomePos);
        positionMap.put("Синий", blueHomePos);
        ...
        pathMap.put("Зеленый", greenPath);
        pathMap.put("Желтый", yellowPath);
        pathMap.put("Красный", redPath);
        pathMap.put("Синий", bluePath);
